...
describe("Favorite Blog", () => {
    ...
    test("with one blog in list, outputs that blog", () => {
        const blogs = [
            {
    ...
    test("with multiple blogs in the list, outputs the blog with most likes", () => {
        const blogs = [
            {
                _id: "5a422a851b54a676234d17f7",
                title: "React patterns",
    ...
    test("with multiples blogs that have same number of likes, outputs any of the tied blogs", () => {
        const blogs = [
            {
                _id: "5a422a851b54a676234d17f7",
                title: "React patterns",
